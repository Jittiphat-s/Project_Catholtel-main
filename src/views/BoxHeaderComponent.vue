...
const cart = computed(() => cart_store.cartList)
    ...
    <header class="border-bottom lh-1 py-3">
          <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 d-flex justify-content-end align-items-center">
              <a class="btn btn-sm btn-outline-secondary" href="#">หน้าหลัก</a>
              <a class="btn btn-sm btn-outline-secondary" href="#">สมัครสมาชิก</a>
              <RouterLink to="/cart" class="btn btn-sm btn-outline-secondary" style="margin-right: 40px;"><span class="spn2">ตระกร้าสินค้า {{ cart.id }}</span></RouterLink> 
